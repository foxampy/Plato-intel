            ...
            <div class="align-md-left align-center pb-55">
                ...
                <div class="row row-footer-law-links">
                    <div class="col-md-auto col-12 col">
                        <a href="{{route('page','privacy-policy')}}" class="__link no-underline block align-md-left align-center"><span class="dashed">Политика конфиденциальности</span></a>
                    </div>
                    <div class="col-md-auto col-12 col">
                        <a href="{{route('page','agreement')}}" class="__link no-underline block align-md-left align-center"><span class="dashed">Соглашение об использовании сайта</span></a>
                    </div>
                </div>
            </div>
                        ...
                        @foreach($siteMenus as $menu)
                            @if($menu->url == 'catalog')
                                <li class="li-mobile-menu li-dropper _js-li-dropper {{ Request::is($menu->url.'*') ? '_active' : '' }}">
                                    ...
                                    <div class="inset _js-inset" style="display: {{ Request::is($menu->url.'*') ? 'block' : 'none' }};">
                                        <ul class="ul-inset">
                                            @foreach($categories as $category)
                                                @if($category->categories->count())
                                                    <li class="li-mobile-menu li-dropper _js-li-dropper {{ Request::is('catalog/'.$category->link().'*') ? '_active' : '' }}">
                                                        <div class="w-relative-b-dropper">
                                                            <a href="{{route('catalog',$category->link())}}" class="mobile-menu__link">{{$category->name}}</a>
                                                            <div class="b-dropper-overlay _js-b-dropper"></div>
                                                        ...
                                                        <div class="inset _js-inset" style="display: {{ Request::is($menu->url.'*') ? 'block' : 'none' }};">
                                                            <ul class="ul-inset">
                                                                ...
                                                                <li class="li-mobile-menu {{ Request::is('catalog/'.$subCategory->link().'*') ? '_active' : '' }}">
                                                                    <a href="{{route('catalog',$subCategory->link())}}" class="mobile-menu__link">{{$subCategory->name}}</a>
                                                                </li>
                                                                @endforeach
                                                            </ul>
                                                        </div>
